...
Zith is a statically typed, compiled systems language with a specification that is ahead of its implementation. The language and compiler are under active development; documentation should be treated as draft material, not as a stability guarantee.
