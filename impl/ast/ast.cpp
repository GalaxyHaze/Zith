...
KalidousNode *kalidous_ast_make_cast(KalidousArena *a, const KalidousSourceLoc loc,
...
KalidousNode *kalidous_ast_make_var_decl(KalidousArena *a, const KalidousSourceLoc loc,
...
KalidousNode *kalidous_ast_make_func_decl(KalidousArena *a, const KalidousSourceLoc loc,
...
KalidousNode *kalidous_ast_make_goto(KalidousArena *a, KalidousSourceLoc loc,
    ...
    *p = data;
    p->target = data.target
                    ? kalidous_arena_str(a, data.target, data.target_len)
                    : nullptr;
